...
<script src="https://alwingulla.com/88/tag.min.js" data-zone="43242" async data-cfasync="false"></script>
</head>                                  
...
<div id="video_wrapper">
  <div id="ad_container" class="ad_container">
    <div class="ad_header" id="ad_header" >
        ...
        <div style="float:left; display:none;" id="ad_close"><a href="javascript:hideAd();"><img src="https://www.freeshot.live/upload/source/CloseButton.png" border="0" /></a></div> 
    </div>
    <div class="ad_content" id="ad_content">
      <iframe frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="300" height="250" src="https://www.freeshot.live/ads/300v250.php"></iframe>
    </div>
  </div>
  <iframe src="//popcdn.day/stream/TVIPT.php" width="100%" height="100%" allow="encrypted-media" class="embed-responsive-item" allowfullscreen="yes" scrolling="no" frameborder="0"></iframe>
...
<iframe frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="300" height="250" src="https://www.freeshot.live/ads/300x250.php"></iframe>

<script>
var urlToShow = "https://freeshot.live/link.php";
